...
expanded_df_with_lengths = expanded_df
expanded_df_with_lengths['pattern_length'] = expanded_df['pattern'].apply(len)
expanded_df_with_lengths['response_length'] = expanded_df['response'].apply(len)

avg_pattern_length = expanded_df_with_lengths.groupby('tag')['pattern_length'].mean()
avg_response_length = expanded_df_with_lengths.groupby('tag')['response_length'].mean()
